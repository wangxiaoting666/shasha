...
width:c.width},c.properties),m=this,l;for(l in h)a.CallBacks[this.instance][l]=function(a){return function(){return a.apply(m.object,arguments)}}(h[l]),g[l]="Swiff.CallBacks."+this.instance+"."http://cdnec.sasa.com/public/app/site/statics/js_mini/+l;f.flashVars=Object.toQueryString(g);Browser.ie?(k.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",f.movie=b):k.type="application/x-shockwave-flash";k.data=b;var d='<object id="'+d+'"',n;for(n in k)d+=" "+n+'="'+k[n]+'"';var d=d+">",q;for(q in f)f[q]&&(d+='<param name="'+q+'" value="'+f[q]+'" />');d+=
